...
if (isset($_POST["btnConRegistro"])) {
    ...
    if (!$error_form_agregar) {
        ...
        $_SESSION["mensaje_accion"] = "Usuario agregado.";
        if ($_FILES["foto"]["name"] != "") {
...
<body>
    ...
    <form action="index.php" method="post" enctype="multipart/form-data">
        <p>
            ...
            <?php
            if (isset($_POST["btnConRegistro"]) && $error_nombre) {
        ...
        <p>
            ...
            <?php
            if (isset($_POST["btnConRegistro"]) && $error_usuario) {
                if ($_POST["usuario"] == "")
                    echo "<span class='error'>* Campo vacío *</span>";
                else
        ...
        <p>
            ...
            <?php
            if (isset($_POST["btnConRegistro"]) && $error_clave) {
                echo "<span class='error'>* Campo vacío *</span>";
            }
            ?>
        </p>
        <p>
            ...
            <?php
            if (isset($_POST["btnConRegistro"]) && $error_dni) {
                if ($_POST["dni"] == "")
                    echo "<span class='error'> * Campo Vacío *</span>";
        ...
        <p>
            ...
            <?php
            if (isset($_POST["btnConRegistro"]) && $error_foto) {
        ...
        <p>
            <button type="submit" name="btnConRegistro">Guardar cambios</button>
