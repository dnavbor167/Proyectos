...
<form action="index.php" method="post" enctype="multipart/form-data">
    ...
    <p>
        ...
        <input type="tipo" name="tipo" <?php if ($tipo == "tipo") echo "checked"; ?> value="normal" id="normal"> <label for="normal"> Normal</label><br />
        <input type="tipo" name="tipo" <?php if ($tipo == "tipo") echo "checked"; ?> value="admin" id="admin"> <label for="admin"> Admin</label><br />
    </p>
