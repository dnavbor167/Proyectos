const DIR_API = "http://localhost/Proyectos/PHP/SERVICIOS_WEB/Actividad1/servicios_rest";
...
function validar_form_editar(codigo) {
    let nombre_corto = $('#nombre_corto').val();

    $.ajax({
        url: DIR_API + "/repetido/producto/nombre_corto/" + nombre_corto + "/cod/" + codigo,
        dataType: "json",
        type: "GET"
    })
        .done(function (data) {
            if (data.error) {
                ...
                $("#error_nombre_corto").html("* Nombre repetido *")
            }
            else {
                ...
                $.ajax({
                    ...
                    .done(function (data) {
                        if (data.error) {
                            ...
                            $("#respuestas").html("<p class='txt_centrado mensaje'>¡¡ Producto actualizado con éxito !!</p>");
                            obtener_productos();
                        }
                    })
                    .fail(function (a, b) {
